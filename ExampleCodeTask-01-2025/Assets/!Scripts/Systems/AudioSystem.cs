...
namespace Logic.Systems
{
    ...
    public class AudioSystem : IAudioSystem, IDisposable
    {
        ...
        private const string SoundVolMixerParam = "Sound";
        private const string MusicVolMixerParam = "Music";
        ...
        public async UniTask Init()
        {
            ...
            var mediator = await _resources.Instantiate<AudioSystemMediator>(
                AddressableConstants.AudioSources);
        ...
        {
            _soundSource.outputAudioMixerGroup.audioMixer.SetFloat(
                SoundVolMixerParam,
